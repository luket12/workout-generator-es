...
test('The workout generator is pre-filled with users from the users json file', function() {
...
test('The workout generator has the expected number of exercise sets for a user', function() {
  // Create a workout generator object with 30 sets

  // The object should have 30 sets
});

test('The workout generator has the expected workout start time', function() {
  // Create a workout generator object

  // The start workout time should be at the next 10 minute interval
});

test('The workout generator has the expected workout end time', function() {
  // Create a workout generator object
